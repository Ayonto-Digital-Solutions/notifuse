...
type CommonStrings struct {
	...
	TeamName string // signature team name, e.g. "The Ayonto Pulse Team"
}
...
var englishTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hello,",
		TeamName: "The Ayonto Pulse Team",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Your Ayonto Pulse authentication code",
		Heading:      "Your authentication code",
		Intro:        "Your authentication code for Ayonto Pulse is:",
		Expiry:       "The code will expire in 10 minutes.",
		IgnoreNotice: "If you did not request this code, please ignore this email.",
		SignOff:      "Thanks,",
	},
	Invitation: InvitationStrings{
		Subject:     "You've been invited to join %s on Ayonto Pulse",
		Heading:     "You've been invited to join Ayonto Pulse!",
		Body:        "%[1]s has invited you to join the %[2]s workspace on Ayonto Pulse.",
...
var frenchTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Bonjour,",
		TeamName: "L'équipe Ayonto Pulse",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Votre code d'authentification Ayonto Pulse",
		Heading:      "Votre code d'authentification",
		Intro:        "Votre code d'authentification pour Ayonto Pulse est :",
		Expiry:       "Ce code expirera dans 10 minutes.",
		IgnoreNotice: "Si vous n'avez pas demandé ce code, veuillez ignorer cet e-mail.",
		SignOff:      "Merci,",
	},
	Invitation: InvitationStrings{
		Subject:     "Vous avez été invité à rejoindre %s sur Ayonto Pulse",
		Heading:     "Vous avez été invité à rejoindre Ayonto Pulse !",
		Body:        "%[1]s vous a invité à rejoindre l'espace de travail %[2]s sur Ayonto Pulse.",
...
var spanishTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hola,",
		TeamName: "El equipo de Ayonto Pulse",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Tu código de autenticación de Ayonto Pulse",
		Heading:      "Tu código de autenticación",
		Intro:        "Tu código de autenticación para Ayonto Pulse es:",
		Expiry:       "El código caducará en 10 minutos.",
		IgnoreNotice: "Si no solicitaste este código, ignora este correo electrónico.",
		SignOff:      "Gracias,",
	},
	Invitation: InvitationStrings{
		Subject:     "Te han invitado a unirte a %s en Ayonto Pulse",
		Heading:     "¡Te han invitado a unirte a Ayonto Pulse!",
		Body:        "%[1]s te ha invitado a unirte al espacio de trabajo %[2]s en Ayonto Pulse.",
...
var germanTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hallo,",
		TeamName: "Das Ayonto Pulse-Team",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Ihr Ayonto Pulse-Authentifizierungscode",
		Heading:      "Ihr Authentifizierungscode",
		Intro:        "Ihr Authentifizierungscode für Ayonto Pulse lautet:",
	...
	Invitation: InvitationStrings{
		Subject:     "Sie wurden eingeladen, %s auf Ayonto Pulse beizutreten",
		Heading:     "Sie wurden zu Ayonto Pulse eingeladen!",
		Body:        "%[1]s hat Sie eingeladen, dem Workspace %[2]s auf Ayonto Pulse beizutreten.",
...
var catalanTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hola,",
		TeamName: "L'equip de Ayonto Pulse",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "El teu codi d'autenticació de Ayonto Pulse",
		Heading:      "El teu codi d'autenticació",
		Intro:        "El teu codi d'autenticació per a Ayonto Pulse és:",
		Expiry:       "El codi caducarà en 10 minuts.",
		IgnoreNotice: "Si no has sol·licitat aquest codi, ignora aquest correu electrònic.",
		SignOff:      "Gràcies,",
	},
	Invitation: InvitationStrings{
		Subject:     "T'han convidat a unir-te a %s a Ayonto Pulse",
		Heading:     "T'han convidat a unir-te a Ayonto Pulse!",
		Body:        "%[1]s t'ha convidat a unir-te a l'espai de treball %[2]s a Ayonto Pulse.",
...
var portugueseBRTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Olá,",
		TeamName: "A equipe da Ayonto Pulse",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Seu código de autenticação da Ayonto Pulse",
		Heading:      "Seu código de autenticação",
		Intro:        "Seu código de autenticação para a Ayonto Pulse é:",
		Expiry:       "O código expirará em 10 minutos.",
		IgnoreNotice: "Se você não solicitou este código, ignore este e-mail.",
		SignOff:      "Obrigado,",
	},
	Invitation: InvitationStrings{
		Subject:     "Você foi convidado para participar de %s na Ayonto Pulse",
		Heading:     "Você foi convidado para participar da Ayonto Pulse!",
		Body:        "%[1]s convidou você para participar do espaço de trabalho %[2]s na Ayonto Pulse.",
...
var japaneseTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "こんにちは、",
		TeamName: "Ayonto Pulse チーム",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Ayonto Pulse 認証コード",
		Heading:      "認証コード",
		Intro:        "Ayonto Pulse の認証コードは次のとおりです:",
		Expiry:       "このコードは10分後に有効期限が切れます。",
		IgnoreNotice: "このコードをリクエストしていない場合は、このメールを無視してください。",
		SignOff:      "よろしくお願いいたします、",
	},
	Invitation: InvitationStrings{
		Subject:     "%s に参加するよう招待されました（Ayonto Pulse）",
		Heading:     "Ayonto Pulse への参加に招待されました！",
		Body:        "%[1]s さんが、Ayonto Pulse のワークスペース %[2]s への参加にあなたを招待しました。",
...
var italianTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Ciao,",
		TeamName: "Il team di Ayonto Pulse",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Il tuo codice di autenticazione Ayonto Pulse",
		Heading:      "Il tuo codice di autenticazione",
		Intro:        "Il tuo codice di autenticazione per Ayonto Pulse è:",
		Expiry:       "Il codice scadrà tra 10 minuti.",
		IgnoreNotice: "Se non hai richiesto questo codice, ignora questa email.",
		SignOff:      "Grazie,",
	},
	Invitation: InvitationStrings{
		Subject:     "Sei stato invitato a unirti a %s su Ayonto Pulse",
		Heading:     "Sei stato invitato a unirti a Ayonto Pulse!",
		Body:        "%[1]s ti ha invitato a unirti allo spazio di lavoro %[2]s su Ayonto Pulse.",
